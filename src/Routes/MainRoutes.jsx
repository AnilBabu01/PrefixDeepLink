...
import LikePlay from "../Screens/Client/LikePlay/LikePlay";
import Payment from "../Screens/Client/Payment/Payment";
  ...
  return (
    <>
      ...
      <Routes>
        ...
        />
        <Route
          path="/admin-panel/LikePlay"
          element={<LikePlay setshowadmin={setshowadmin} />}
        />
        <Route
          path="/admin-panel/Payment"
          element={<Payment setshowadmin={setshowadmin} />}
        />
